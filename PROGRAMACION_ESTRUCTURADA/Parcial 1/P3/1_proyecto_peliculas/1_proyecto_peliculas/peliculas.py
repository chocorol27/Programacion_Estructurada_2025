...
def modificarPeliculas():
    ...
    if conexionBD!=None:
      ...
      if registros:
        ...
        if resp=="si":
           nuevonombre=input("NOMBRE: ").upper().strip()
           nuevacategoria=input("CATEGORIA:")
           nuevaclasificacion=input("Clasificacion:")
           nuevogenero=input("Genero:")
           nuevoidioma=input("Idioma:")
           sql="update peliculas set nombre =%s, categoria=%s, clasificacion=%s , genero=%s , idioma=%s "
           val=(nuevonombre,nuevacategoria,nuevaclasificacion,nuevogenero,nuevoidioma,)
           cursor.execute(sql,val)
           conexionBD.commit()
           print("\n\t\t :::¡LA OPERACION SE REALIZÓ CON EXÍTO! :::")
      else:
